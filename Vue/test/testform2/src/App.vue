<template>
  <div id="app">
    ...
    <div class="w3-container" style="border: 0px solid blue">
      <div>
        <MagForm
          :fieldDefinitions="this.tableDefA"
          title="Input 1"
    ...
    <div class="w3-container" style="border: 0px solid green">
      <div>
        <MagForm
          :fieldDefinitions="this.tableDefB"
          title="Input 2"
          @valuechanged="onValueChanged"
          @lostfocus="onLostFocus"
          @buttonpressed="onButtonPressed"
    ...
    <div class="w3-container" style="border: 0px solid orange">
      <div>
        <MagForm
          :refresh="refresh"
          :fieldDefinitions="this.tableTest.getFields()"
          :buttonDefinitions="this.buttonDefA"
          title="Teszt form"
          @valuechanged="onValueChanged"
          @lostfocus="onLostFocus"
          @buttonpressed="onButtonPressed"
        ...
        <div class="w3-container" style="border: 0px solid red">
          <p>
            Value of test field t1: {{ this.tableTest.getFields()[0].value }}
          </p>
          <p>
            Value of test field t2: {{ this.tableTest.getFields()[1].value }}
          </p>
          <p>
            Value of test field t3: {{ this.tableTest.getFields()[2].value }}
          </p>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    onButtonPressed(name) {
      ...
      switch (name) {
        ...
        case "btnSave":
          s = "";
          s += this.tableTest.getFields()[0].value + "\n";
          s += this.tableTest.getFields()[1].value + "\n";
          s += this.tableTest.getFields()[2].value + "\n";
          alert(s);
          break;
        case "btnRefresh":
          break;
        case "btnClear":
          this.tableTest.getFields()[0].value = "";
          this.tableTest.getFields()[1].value = "";
          this.tableTest.getFields()[2].value = "";
          this.refresh = !this.refresh;
          break;
      }
    },
