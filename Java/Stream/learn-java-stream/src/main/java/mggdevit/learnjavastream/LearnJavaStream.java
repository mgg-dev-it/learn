...
public class LearnJavaStream {

	public static void main(String[] args) {
		LearnJavaStream.learn();
	}
	...
	public static void learn() {
		...
		System.out.println(
				"List<String> made from sample data array with 'Arrays.asList(T... a)': " + stringList.toString());
		...
		dumpStringStream("Stream created with 'Stream.builder()'",
		...
		dumpStringStream("Stream created with 'Pattern.compile(\", \").splitAsStream(\"a, b, c\")'",
		...
		System.out.println("Stream any match 'anyMatch(s -> s.contains(\"a\"))': "
				+ Stream.of(sampleData).anyMatch(s -> s.contains("a")));
		System.out.println("Stream all match: 'allMatch(s -> s.contains(\"a\"))': "
				+ Stream.of(sampleData).allMatch(s -> s.contains("a")));
		System.out.println("Stream none match: 'noneMatch(s -> s.contains(\"a\"))': "
				+ Stream.of(sampleData).noneMatch(s -> s.contains("a")));

		System.out.println("");
		System.out.println("Stream to stream");
		System.out.println("----------------");
		dumpStringStream("Five elements of the stream", Stream.of(sampleData).limit(5));
		dumpStringStream("Filtered stream with 'filter(element -> element.contains(\"b\")'",
				Stream.of(sampleData).filter(element -> element.contains("b")));
		...
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new)': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)));
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new).getCount()': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)).getCount());
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new).getMin()': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)).getMin());
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new).getAverage()': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)).getAverage());
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new).getMax()': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)).getMax());
		System.out.println(integerList.toString() + " 'Collectors.summarizingInt(Integer::new).getSum()': "
				+ integerList.stream().collect(Collectors.summarizingInt(Integer::new)).getSum());

		System.out.println("");
		System.out.println("---");
		dumpStringStream("Ordered stream", Stream.of(sampleData).sorted((String s1, String s2) -> (s1.compareTo(s2))));
		dumpStringOptional("First element of the ordered stream ",
				Stream.of(sampleData).sorted((String s1, String s2) -> (s1.compareTo(s2))).findFirst());
		dumpStringStream("Five elements of the ordered stream",
				Stream.of(sampleData).sorted((String s1, String s2) -> (s1.compareTo(s2))).limit(5));
